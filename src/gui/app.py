...
from src.gui.subtitle_processor import SubtitleProcessor, ProgressWindow
    ...
    def generate_subtitles(self):
        ...
        def process():
            try:
                ...
                messagebox.showinfo("Thông báo", "Đã tạo phụ đề xong!")
    ...
    def translate_subtitles(self):
        ...
        def process():
            try:
                ...
                progress_window.close()
                messagebox.showinfo("Thông báo", "Đã dịch phụ đề xong!")
            except Exception as e:
                progress_window.close()
                messagebox.showerror("Lỗi", str(e))
...
class PromptDialog:
    def __init__(self, parent, title, name="", content=""):
        ...
        ttk.Entry(self.dialog, textvariable=self.name_var, width=50).grid(row=0, column=1, sticky=(tk.W, tk.E), padx=5)
        
        ttk.Label(self.dialog, text="Nội dung:").grid(row=1, column=0, sticky=tk.W, padx=5, pady=5)
        self.content_text = tk.Text(self.dialog, height=15, width=70)
        self.content_text.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E), padx=5)
